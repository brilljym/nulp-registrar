...
<body>
    <div class="email-container">
        <div class="header">
            ...
            <p>Your <?php echo e($requestType); ?> document request has been successfully completed</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="message">
                <p>Congratulations! Your <?php echo e($requestType); ?> document request has been successfully completed. Please check your email for further updates about your requested documents. We will notify you once your documents are ready for pickup.</p>
            </div>
            ...
            <div class="request-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">
                        <span class="status-badge status-completed"><?php echo e(ucfirst($request->status)); ?></span>
                    </span>
                </div>
                <div class="detail-row">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value"><?php echo e($request->updated_at->format('M j, Y g:i A')); ?></span>
                </div>
            </div>
...
</html><?php /**PATH D:\Nu-Regisv2\resources\views/emails/request-completed.blade.php ENDPATH**/ ?>