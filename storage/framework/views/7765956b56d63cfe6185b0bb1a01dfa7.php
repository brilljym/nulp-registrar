    ...
    <?php if(auth()->guard()->check()): ?>
        <div class="user-dropdown" id="userDropdown">
            ...
            <div class="user-dropdown-menu">
                <?php if(Auth::user()->role && Auth::user()->role->name === 'student'): ?>
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('logout.post')); ?>" method="POST" style="margin: 0;">
                    <?php echo csrf_field(); ?>
...
<div class="layout-container">
    ...
    <div class="sidebar pt-0" id="sidebar">
        <div class="px-2">
            ...
            <a href="<?php echo e(route('student.request.document')); ?>" class="<?php echo e(request()->routeIs('student.request.document') ? 'active' : ''); ?>">
                <i class="bi bi-file-earmark-text"></i>
                <span class="nav-text">Request Documents</span>
            </a>
            <a href="<?php echo e(route('student.my-requests')); ?>" class="<?php echo e(request()->routeIs('student.my-requests', 'student.track') ? 'active' : ''); ?>">
...
<?php /**PATH D:\Nu-Regisv2\resources\views/layouts/app.blade.php ENDPATH**/ ?>