...
<div class="mb-3">
  ...
  <input
    ...
    id="school_email"
    name="school_email"
    value="<?php echo e(old('school_email', $user->school_email ?? 'auto-generated')); ?>"
    readonly
  >
...
<div class="mb-3">
  ...
  <select name="role_id" id="role_id" class="form-select" required onchange="toggleStudentFields(this.value)">
    <?php $__currentLoopData = \App\Models\Role::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <option value="<?php echo e($role->id); ?>" <?php if(isset($user) && $user->role_id == $role->id): echo 'selected'; endif; ?>>
...
<div id="student-fields" style="display: <?php echo e((isset($user) && $user->role_id == 3) || (!isset($user) && old('role_id') == 3) ? 'block' : 'none'); ?>;">
  <hr class="my-4">
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="mb-3">
        ...
        <select name="course" id="course_edit_<?php echo e($user->id ?? 'create'); ?>" class="form-select course-select">
    ...
    <div class="col-md-6">
      <div class="mb-3">
        ...
        <select name="year_level" id="year_level_edit_<?php echo e($user->id ?? 'create'); ?>" class="form-select year-level-select" disabled>
  ...
  <div class="mb-3">
    ...
    <select name="department" id="department_edit_<?php echo e($user->id ?? 'create'); ?>" class="form-select department-select" disabled>
...
<?php /**PATH D:\Nu-Regisv2\resources\views\admin\users\form-fields.blade.php ENDPATH**/ ?>