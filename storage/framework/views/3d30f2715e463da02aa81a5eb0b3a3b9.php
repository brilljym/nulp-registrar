...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Waiting queue fills its allocated space */
...
<body>
    ...
    <div class="content-wrapper">
        ...
        <main class="main-container">
            ...
            </div><!-- end queue-center -->

            <!-- Right Side Panel: Slideshow (top) + Video (bottom) -->
            <div class="right-panel">
                <div class="side-panel side-panel-slideshow">
                    <div class="image-slideshow-container" id="imageSlideshowContainer">
                        ...
                        <div class="image-slideshow" id="imageSlideshow">
                            <?php $__currentLoopData = $displaySlides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="slideshow-slide <?php echo e($i === 0 ? 'active' : ''); ?>"
                                     style="background-image: url('<?php echo e($slide['url']); ?>');"></div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        <div class="slideshow-indicators" id="slideshowIndicators">
                            <?php $__currentLoopData = $displaySlides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="slideshow-indicator <?php echo e($i === 0 ? 'active' : ''); ?>" data-slide="<?php echo e($i); ?>"></div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                </div>
                <div class="side-panel side-panel-video">
                    <div class="video-ad-container" id="videoAdContainer">
                        ...
                        <video id="nuAdvertisementVideo" muted playsinline>
                            <source src="<?php echo e($displayVideoUrl); ?>" type="video/mp4">
                        </video>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH C:\Users\Brill\nu-regis\resources\views/queue/display.blade.php ENDPATH**/ ?>