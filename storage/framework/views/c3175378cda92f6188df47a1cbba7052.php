            ...
            <tbody>
                ...
                <tr class="table-row">
                    ...
                    <td class="text-center">
                        <span class="badge bg-<?php echo e($req->status === 'completed' ? 'success' : ($req->status === 'pending' ? 'warning' : ($req->status === 'registrar_approved' ? 'info' : ($req->status === 'processing' ? 'primary' : ($req->status === 'released' ? 'success' : ($req->status === 'in_queue' ? 'primary' : ($req->status === 'ready_for_pickup' ? 'warning' : ($req->status === 'waiting' ? 'secondary' : 'secondary')))))))); ?> rounded-pill px-3">
