    ...
    <div class="row mb-4">
        <div class="col-lg-4">
            <div class="compliance-card">
                ...
                <div class="compliance-score"><?php echo e(number_format($complianceMetrics['data_privacy_compliance']['data_retention_compliance']['compliance_percentage'], 1)); ?>%</div>
                <p class="text-muted mb-2">Overall compliance score</p>
                <div class="mt-3">
                    <span class="status-indicator status-green"></span>
                    <small><?php echo e(number_format($complianceMetrics['data_privacy_compliance']['total_requests_with_consent'])); ?> requests with proper consent</small>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="compliance-card">
                ...
                ?>
                <div class="compliance-score"><?php echo e(number_format($slaCompliance, 1)); ?>%</div>
                <p class="text-muted mb-2">Processing time compliance</p>
                <div class="mt-3">
                    <span class="status-indicator <?php echo e($slaCompliance >= 90 ? 'status-green' : ($slaCompliance >= 75 ? 'status-yellow' : 'status-red')); ?>"></span>
                    <small><?php echo e(number_format($complianceMetrics['processing_time_compliance']['within_sla'])); ?> within SLA</small>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="compliance-card">
                ...
                <div class="mt-3">
                    <span class="status-indicator status-green"></span>
                    <small><?php echo e(number_format($securityMetrics['access_control']['active_admin_accounts'] + $securityMetrics['access_control']['active_registrar_accounts'])); ?> active secure accounts</small>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="stakeholder-section">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="kpi-card">
                    <div class="kpi-value"><?php echo e($operationalEfficiency['performance_metrics']['average_processing_time']['formatted']); ?></div>
                    <div class="kpi-label">Average Processing Time</div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="kpi-card">
                    <div class="kpi-value"><?php echo e(number_format($operationalEfficiency['performance_metrics']['queue_efficiency'])); ?>%</div>
                    <div class="kpi-label">Queue Efficiency</div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="kpi-card">
                    <div class="kpi-value">₱<?php echo e(number_format($operationalEfficiency['cost_effectiveness']['operational_savings']['monthly_savings'])); ?></div>
                    <div class="kpi-label">Monthly Savings</div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="kpi-card">
                    <div class="kpi-value"><?php echo e(number_format($operationalEfficiency['resource_utilization']['system_uptime'], 1)); ?>%</div>
        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="text-center">
                            <div class="kpi-value text-success"><?php echo e(number_format($qualityAssurance['accuracy_metrics']['first_time_right'], 1)); ?>%</div>
                            <div class="kpi-label">First Time Right</div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="text-center">
                            <div class="kpi-value text-info"><?php echo e(number_format($qualityAssurance['accuracy_metrics']['error_rate'], 2)); ?>%</div>
                            <div class="kpi-label">Error Rate</div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="text-center">
                            <div class="kpi-value text-warning"><?php echo e(number_format($qualityAssurance['accuracy_metrics']['rework_percentage'], 1)); ?>%</div>
            ...
            <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="text-center">
                            <div class="kpi-value text-success"><?php echo e(number_format($qualityAssurance['customer_satisfaction']['completion_rate'], 1)); ?>%</div>
                            <div class="kpi-label">Completion Rate</div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="text-center">
                            <div class="kpi-value text-primary"><?php echo e(number_format($qualityAssurance['customer_satisfaction']['on_time_delivery'], 1)); ?>%</div>
                            <div class="kpi-label">On-Time Delivery</div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="text-center">
                            <div class="kpi-value text-info"><?php echo e($qualityAssurance['customer_satisfaction']['complaint_resolution']['resolution_rate']); ?>%</div>
            ...
            <div class="col-lg-4">
                ...
                <div class="mb-2">
                    <div class="d-flex justify-content-between">
                        ...
                        <strong><?php echo e(number_format($stakeholderSatisfaction['student_satisfaction']['completion_within_timeline'], 1)); ?>%</strong>
                    </div>
                </div>
                <div class="mb-2">
                    <div class="d-flex justify-content-between">
                        <span>Ease of Use</span>
                        <strong><?php echo e(number_format($stakeholderSatisfaction['student_satisfaction']['ease_of_use_rating'], 1)); ?>/5</strong>
                    </div>
                </div>
                <div class="mb-2">
                    <div class="d-flex justify-content-between">
                        <span>Overall Satisfaction</span>
                        <strong><?php echo e(number_format($stakeholderSatisfaction['student_satisfaction']['overall_satisfaction'], 1)); ?>/5</strong>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                ...
                <div class="mb-2">
                    <div class="d-flex justify-content-between">
                        ...
                        <strong><?php echo e(number_format($stakeholderSatisfaction['registrar_satisfaction']['system_usability'], 1)); ?>/5</strong>
                    </div>
                </div>
                <div class="mb-2">
                    <div class="d-flex justify-content-between">
                        <span>Workload Management</span>
                        <strong><?php echo e(number_format($stakeholderSatisfaction['registrar_satisfaction']['workload_manageability'], 1)); ?>/5</strong>
                    </div>
                </div>
                <div class="mb-2">
                    <div class="d-flex justify-content-between">
                        <span>Training Adequacy</span>
                        <strong><?php echo e(number_format($stakeholderSatisfaction['registrar_satisfaction']['training_adequacy'], 1)); ?>/5</strong>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                ...
                <div class="mb-2">
                    <div class="d-flex justify-content-between">
                        ...
                        <strong><?php echo e(number_format($stakeholderSatisfaction['administrative_satisfaction']['reporting_adequacy'], 1)); ?>/5</strong>
                    </div>
                </div>
                <div class="mb-2">
                    <div class="d-flex justify-content-between">
                        <span>Data Accuracy</span>
                        <strong><?php echo e(number_format($stakeholderSatisfaction['administrative_satisfaction']['data_accuracy'], 1)); ?>/5</strong>
                    </div>
                </div>
                <div class="mb-2">
                    <div class="d-flex justify-content-between">
                        <span>Compliance Support</span>
                        <strong><?php echo e(number_format($stakeholderSatisfaction['administrative_satisfaction']['compliance_support'], 1)); ?>/5</strong>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="bottleneck-indicator">
                    <strong><?php echo e($qualityAssurance['process_improvement']['bottleneck_identification']['primary_bottleneck']); ?></strong>
                    <p class="mb-1 text-muted"><?php echo e($qualityAssurance['process_improvement']['bottleneck_identification']['improvement_potential']); ?></p>
                </div>
                <div class="bottleneck-indicator">
                    <strong><?php echo e($qualityAssurance['process_improvement']['bottleneck_identification']['secondary_bottleneck']); ?></strong>
                    <p class="mb-0 text-muted">Requires workflow optimization</p>
                </div>
            </div>
            <div class="col-lg-6">
                <h6>Improvement Initiatives</h6>
                <?php $__currentLoopData = $qualityAssurance['process_improvement']['improvement_initiatives']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $initiative => $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <span><?php echo e(ucwords(str_replace('_', ' ', $initiative))); ?></span>
                    <span class="improvement-badge"><?php echo e($status); ?></span>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-sm">
                        <tr>
                            ...
                            <td class="text-end"><strong><?php echo e(number_format($auditTrail['document_processing_trail']['onsite_requests_with_registrar_assignment'])); ?></strong></td>
                        </tr>
                        <tr>
                            <td>Status Change Logs</td>
                            <td class="text-end"><strong><?php echo e(number_format($auditTrail['document_processing_trail']['status_change_logs'])); ?></strong></td>
                        </tr>
                        <tr>
                            <td>Payment Approval Trail</td>
                            <td class="text-end"><strong><?php echo e(number_format($auditTrail['document_processing_trail']['payment_approval_trail'])); ?></strong></td>
                        </tr>
                    </table>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Nu-Regisv2\resources\views/admin/pia-reports.blade.php ENDPATH**/ ?>