                            ...
                            <table class="table table-hover">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="text-end fw-semibold text-muted" style="font-size: 0.85rem;">Unit Price</th>
                                        <th class="text-end fw-semibold text-muted" style="font-size: 0.85rem;">Total</th>
                                    </tr>
                                </thead>
                                <tbody>
