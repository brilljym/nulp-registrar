...
<?php $__env->startSection('title', 'Queue Display Media - NU Lipa Admin'); ?>
            ...
            <div class="card media-card">
                <div class="card-header" style="background:linear-gradient(135deg,#003399,#001f5f); color:#fff;">
                    ...
                    <span class="badge ms-auto" style="background:rgba(255,255,255,0.2); font-weight:600;">
                        <?php echo e(count($slides)); ?> slide<?php echo e(count($slides) !== 1 ? 's' : ''); ?>
                ...
                <div class="card-body">
                            ...
                            <?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                                    <div class="slide-item">
                                        <img src="<?php echo e($slide['url']); ?>" alt="<?php echo e($slide['filename']); ?>" class="slide-thumb">

                                        <?php if($slide['custom']): ?>
                                            
                                            <form method="POST"
                                                  action="<?php echo e(route('admin.display-media.slide.delete', $slide['id'])); ?>"
                                    ...
                                    <p class="text-muted mt-1 text-truncate" style="font-size:.75rem;"><?php echo e($slide['filename']); ?></p>
                                </div>
                    ...
                    <form method="POST" action="<?php echo e(route('admin.display-media.slide.upload')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if(collect($slides)->where('custom', true)->isEmpty() && count($slides) > 0): ?>
                ...
                <div class="card-body">
                    <div class="row g-4 align-items-start">
                        <div class="col-md-6">
                            ...
                            <?php if($videoRecord): ?>
                                <p class="mt-2 mb-0" style="font-size:.8rem;">
                                    ...
                                    <strong><?php echo e($videoRecord->original_name); ?></strong>
                                    <span class="text-muted ms-2">— uploaded <?php echo e($videoRecord->created_at->diffForHumans()); ?></span>
                                </p>
                            <?php else: ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <form method="POST" action="<?php echo e(route('admin.display-media.video.upload')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Brill\nu-regis\resources\views/admin/display-media.blade.php ENDPATH**/ ?>