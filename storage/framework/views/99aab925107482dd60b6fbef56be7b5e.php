...
<div class="container mt-5">
    <h2 class="mb-4">
        <i class="bi bi-clock-fill text-warning"></i> My Pending Requests (Window <?php echo e($windowNumber ?? 'N/A'); ?>)
    </h2>
    ...
    ?>
    <?php if(isset($isWindowOccupied) && isset($windowNumber) && $hasActiveRequests): ?>
    ...
    <div class="mb-5">
        ...
        <table class="table table-hover align-middle">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $onsiteRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="table-row">
    ...
    <div class="mb-5">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $kioskRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="table-row">
                        <td class="text-center fw-bold text-muted"><?php echo e($index + 1); ?></td>
                        <td>
                            <div class="fw-semibold"><?php echo e($request->student->user->first_name); ?> <?php echo e($request->student->user->last_name); ?></div>
...
<?php echo $__env->make('layouts.registrar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Nu-Regisv2\resources\views/registrar/dashboard_pending.blade.php ENDPATH**/ ?>