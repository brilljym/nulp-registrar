...
<head>
    ...
    <title>NU Lipa - Request Ready</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-container">
        <div class="header">
            ...
            <h1>📦 Ready</h1>
            <p>Your <?php echo e($requestType); ?> document request is ready for pickup</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="message">
                <p>Excellent news! Your <?php echo e($requestType); ?> document request has been processed and is now Ready. Please check your email for further updates about your requested documents. </p>
            </div>
            ...
            <div class="request-details">
                ...
                <?php if($request->queue_number): ?>
                <div class="detail-row">
                    <span class="detail-label">Queue Number:</span>
                    <span class="detail-value">
                        <strong style="font-size: 18px; color: #2c2f92;"><?php echo e($request->queue_number); ?></strong>
                    </span>
                </div>
                <?php endif; ?>
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">
                        <span class="status-badge status-released"><?php echo e(ucfirst($request->status)); ?></span>
                    </span>
                </div>
                <div class="detail-row">
                ...
                <div class="detail-row">
                    <span class="detail-label">Expected Release:</span>
                    <span class="detail-value"><?php echo e(\Carbon\Carbon::parse($request->expected_release_date)->format('M j, Y g:i A')); ?></span>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="highlight-box">
                ...
                <div class="highlight-subtext">
                    Use your queue number at the kiosk to confirm pickup
                    <?php if($request->queue_number): ?>
                        <br><strong>Your Queue Number: <?php echo e($request->queue_number); ?></strong>
                    <?php endif; ?>
                </div>
            </div>

            <div class="message">
                <p><strong>Important:</strong> Please visit the registrar's office as soon as possible to pick up your documents. Bring the following:</p>
                <ul>
                    <?php if($request->queue_number): ?>
                    <li><strong>Your queue number: <?php echo e($request->queue_number); ?></strong> (use this at the kiosk)</li>
                    <?php endif; ?>
                    <li>Your reference code: <strong><?php echo e($requestType === 'onsite' ? $request->ref_code : $request->reference_no); ?></strong></li>
                    <li>Valid student ID or government-issued ID</li>
                    <li>This email confirmation</li>
                </ul>

                <p>If you have any questions or need assistance, please contact the registrar's office immediately.</p>
            </div>
        </div>
...
</html><?php /**PATH D:\Nu-Regisv2\resources\views\emails\request-ready-for-release.blade.php ENDPATH**/ ?>