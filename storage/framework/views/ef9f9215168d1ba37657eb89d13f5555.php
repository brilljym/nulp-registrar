    ...
    <div class="alert alert-light border-start border-4 border-info">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                To track pending requests, please visit the <a href="<?php echo e(route('student.request.document')); ?>" class="text-decoration-none">Request Document</a> page.
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Nu-Regisv2\resources\views\student\completed.blade.php ENDPATH**/ ?>