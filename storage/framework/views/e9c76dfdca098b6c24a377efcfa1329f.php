    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-content">
            ...
            <div class="nav-section">
                ...
                <a href="<?php echo e(route('admin.users.index')); ?>" class="<?php echo e(request()->is('admin/users*') && !request()->is('admin/students*') && !request()->is('admin/registrars*') ? 'active' : ''); ?>">
                    <i class="bi bi-people"></i>
                    <span class="nav-text">All Users</span>
                </a>
                <a href="<?php echo e(route('admin.students.index')); ?>" class="<?php echo e(request()->is('admin/students*') ? 'active' : ''); ?>">
                    <i class="bi bi-mortarboard"></i>
                    <span class="nav-text">Students</span>
                </a>
                <a href="<?php echo e(route('admin.registrars.index')); ?>" class="<?php echo e(request()->is('admin/registrars*') ? 'active' : ''); ?>">
            ...
            <div class="nav-section">
                ...
                <a href="<?php echo e(route('admin.documents.index')); ?>" class="<?php echo e(request()->is('admin/documents*') ? 'active' : ''); ?>">
            ...
            <div class="nav-section">
                ...
                <a href="<?php echo e(route('admin.reports')); ?>" class="<?php echo e(request()->is('admin/reports') ? 'active' : ''); ?>">
            ...
            <div class="nav-section">
                <div class="nav-section-title">Queue Display</div>
                <a href="<?php echo e(route('admin.display-media.index')); ?>" class="<?php echo e(request()->is('admin/display-media*') ? 'active' : ''); ?>">
                    <i class="bi bi-display"></i>
                    <span class="nav-text">Display Media</span>
                </a>
            </div>
