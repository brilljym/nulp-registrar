...
<div class="container mt-5">
    <h2 class="mb-4">
        <i class="bi bi-clock-fill text-warning"></i> Pending Document Requests
    </h2>
    ...
    <div class="table-responsive">
        <table class="table table-hover align-middle">
            ...
            <tbody>
                ...
                <?php $__currentLoopData = $pending; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="table-row">
    ...
    <?php if($pending->isEmpty()): ?>
        <div class="alert alert-info text-center mt-4">No requests in progress found.</div>
    <?php endif; ?>
</div>
