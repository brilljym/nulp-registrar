...
<body>
    ...
    <header class="nu-header">
        <div class="d-flex align-items-center gap-2">
            <img src="<?php echo e(asset('images/NU_shield.svg.png')); ?>" alt="NU Shield" class="nu-shield" style="height:1.8rem;">
    ...
    <main class="main-content">
        <div class="container py-5">
            ...
            <?php $__currentLoopData = ['success','error','info']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(session($msg)): ?>
                    <div class="alert alert-<?php echo e($msg === 'error' ? 'danger' : $msg); ?> text-center">
                            ...
                            <div class="mb-2 d-flex justify-content-center">
                                <div class="rounded-circle d-flex align-items-center justify-content-center shadow-sm"
                                     style="width:55px; height:55px;
                                            background-color: <?php echo e($index < $currentIndex ? '#198754' : ($index === $currentIndex ? '#0d6efd' : '#dee2e6')); ?>;
                                            color:#fff; font-size:24px;">
                                    <?php echo e($step['icon']); ?>

                                </div>
                            </div>
                            <div class="fw-semibold small <?php echo e($index < $currentIndex ? 'text-success' : ($index === $currentIndex ? 'text-primary' : 'text-muted')); ?>">
            ...
            <div class="text-center">
                <?php echo $__env->make('onsite.partials.step-details', ['onsiteRequest' => $onsiteRequest, 'ticketNumber' => $ticketNumber], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
    </main>
    ...
    <script>
        ...
        const interval=setInterval(()=>{count--; if(count>0){countdownEl.textContent=`Redirecting to login in ${count}...`}else{clearInterval(interval);window.location.href="<?php echo e(route('login')); ?>" }},1000);
    </script>
    <?php endif; ?>
</body>
</html>
<?php /**PATH D:\Nu-Regisv2\resources\views\onsite\track.blade.php ENDPATH**/ ?>