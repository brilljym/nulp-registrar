    ...
    <div class="container">
        <div class="feedback-container">
            ...
            <div class="ticket-info">
                <div class="row">
                    <div class="col-md-6">
                        <strong>Name:</strong> <?php echo e($onsiteRequest->full_name); ?><br>
                        <strong>Document:</strong> <?php echo e($onsiteRequest->document->name ?? 'N/A'); ?><br>
                    </div>
                    <div class="col-md-6">
                        <strong>Completed:</strong> <?php echo e($onsiteRequest->updated_at->format('M d, Y H:i')); ?><br>
                        <strong>Reference:</strong> <?php echo e($onsiteRequest->ref_code ?? 'N/A'); ?>
            ...
            <form method="POST" action="<?php echo e(route('onsite.feedback.store', $onsiteRequest->id)); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-4">
                    ...
                    <div class="rating-stars">
                        <?php for($i = 1; $i <= 5; $i++): ?>
                            <span class="star" data-rating="<?php echo e($i); ?>">⭐</span>
                        <?php endfor; ?>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex justify-content-between">
                    <a href="<?php echo e(route('onsite.timeline', $onsiteRequest->id)); ?>" class="btn btn-secondary">
...
</html><?php /**PATH D:\Nu-Regisv2\resources\views\onsite\feedback.blade.php ENDPATH**/ ?>