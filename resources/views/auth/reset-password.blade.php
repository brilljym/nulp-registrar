...
<head>
    ...
    <title>Reset Password - NU Document Request - NU Lipa</title>
...
<body>
    ...
    <div class="content-wrapper">
        ...
        <header class="nu-header">
            ...
            <span class="nu-welcome">Reset Your Password</span>
        </header>
        ...
        <main class="main-content">
            <div class="document-request-card">
                ...
                <form method="POST" action="{{ route('password.update') }}" novalidate>
                    ...
                    <div class="mb-3">
                        <label for="email" class="form-label">
                            <i class="bi bi-envelope" aria-hidden="true"></i>Personal Email Address
                        </label>
                        <input type="email"
                               class="form-control"
                               id="email"
                    ...
                    <div class="mb-3">
                        <label for="password" class="form-label">
                            <i class="bi bi-lock" aria-hidden="true"></i>New Password
                        </label>
                        ...
                        <small id="password-help" class="form-text text-muted">
                            Must contain at least one lowercase, one uppercase letter, and one number
                        </small>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <small id="confirm-help" class="form-text text-muted visually-hidden">
                            Re-enter your new password
                        </small>
                    </div>

                    <button type="submit" class="btn-primary-custom mb-3" aria-label="Reset your password">
                        <i class="bi bi-key"></i>
                ...
                <p class="text-muted" style="font-size: 0.875rem; margin-top: 1rem;">
                    ...
                    <a href="{{ route('login') }}" class="text-decoration-none" style="color: var(--primary-blue); font-weight: 500;">
                        Sign In
                    </a>
                </p>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (resetForm) {
                resetForm.addEventListener('submit', function(e) {
                    ...
                    if (!password.value || !confirmPassword.value) {
                        ...
                        const firstEmpty = password.value ? confirmPassword : password;
                        firstEmpty.focus();
            ...
            setupPasswordToggle('password_confirmation', 'toggleConfirmPassword', 'confirmIcon');
