    ...
    <div class="content-wrapper">
        ...
        <main class="main-content">
            <div class="document-request-card">
                ...
                <!-- Login Button -->
                <a href="{{ route('auth.login') }}" class="btn-login" aria-label="Go to login page">
                ...
                <!-- Walk-In Button -->
                <a href="{{ route('onsite.index') }}" class="btn-walkin" aria-label="Request documents without login">
        ...
        <div class="instr-modal-box" role="dialog" aria-modal="true" aria-labelledby="instrModalTitle">
            ...
            <div class="instr-slides">
                <div class="instr-slide active" data-slide="0">
                    <img src="{{ asset('images/instructions/INSTRUCTION1.png') }}" alt="Step 1 - Login Instructions">
                </div>
                <div class="instr-slide" data-slide="1">
                    <img src="{{ asset('images/instructions/INSTRUCTION2.png') }}" alt="Step 2 - Request Instructions">
                </div>
                <div class="instr-slide" data-slide="2">
                    <img src="{{ asset('images/instructions/INSTRUCTION3.png') }}" alt="Step 3 - Tracking Instructions">
                </div>
            </div>
