...
<head>
    ...
    <title>Request Status - {{ $studentRequest->reference_no }}</title>
...
<body>
    ...
    <div class="site-content">
        ...
        <header class="nu-header">
            ...
            <a href="{{ route('public.track') }}" class="back-button">
        ...
        <main class="main-content">
            <div class="result-container">
                ...
                <div class="info-card">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="fw-semibold">{{ $studentRequest->expected_release_date->format('M d, Y') }}</div>
                            <small class="text-muted">{{ $studentRequest->expected_release_date->diffForHumans() }}</small>
                        </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="info-card">
                    ...
                    @elseif($studentRequest->payment_receipt_path)
                ...
                <div class="text-center mt-4">
                    <a href="{{ route('public.track') }}" class="btn btn-primary me-2">
