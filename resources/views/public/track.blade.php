    ...
    <div class="site-content">
        ...
        <main class="main-content">
            <div class="search-container">
                ...
                <form class="search-form" action="{{ route('public.track.search') }}" method="GET">
                    <div class="mb-3">
                ...
                <div class="help-links">
                    <a href="{{ route('student.request.document') }}" class="help-link">
                        <i class="bi bi-plus-circle me-1"></i>Submit New Request
                    </a>
                    <a href="{{ route('onsite.index') }}" class="help-link">
