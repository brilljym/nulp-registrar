              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input
                    ...
                    id="school_email"
                    name="school_email"
                    value="{{ old('school_email', 'auto-generated') }}"
                    readonly
                  >
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <select name="course" id="course" class="form-select course-select" onchange="updateDepartmentOptions()">
                    ...
                    <option value="SACE" @selected(old('course') == 'SACE')>School of Architecture and Civil Engineering (SACE)</option>
                    <option value="SAHS" @selected(old('course') == 'SAHS')>School of Allied Health Sciences (SAHS)</option>
                    <option value="SABM" @selected(old('course') == 'SABM')>School of Accountancy and Business Management (SABM)</option>
                    <option value="SHS" @selected(old('course') == 'SHS')>Senior High School (SHS)</option>
                  </select>
                </div>
              </div>
