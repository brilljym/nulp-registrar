    ...
    <div class="table-responsive">
        <table class="table table-hover align-middle">
            ...
            <tbody>
                ...
                <tr class="table-row">
                    <td class="text-center fw-bold text-muted">{{ $students->firstItem() + $index }}</td>
                    <td class="text-primary fw-semibold">{{ $student->student_id }}</td>
                    <td class="fw-semibold">
                        {{ optional($student->user)->last_name }}, {{ optional($student->user)->first_name }} {{ optional($student->user)->middle_name }}
                    </td>
                    <td class="text-secondary">
                        <span class="badge bg-info rounded-pill px-2">{{ strtoupper($student->department ?? 'N/A') }}</span>
                    </td>
                    <td class="text-muted fw-medium">{{ $student->course ?? 'N/A' }}</td>
                    <td class="text-center">
                        <span class="badge bg-success rounded-pill px-3">{{ strtoupper($student->year_level ?? 'N/A') }}</span>
                    </td>
                    <td class="text-center">
                        <!-- View Icon Button -->
                        <a href="{{ route('admin.students.show', $student) }}" class="btn btn-outline-info btn-sm me-2 action-btn view-btn"
