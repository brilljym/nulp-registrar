...
<div class="container-fluid mt-4">
                ...
                <div class="no-print">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('admin.reports.export', ['type' => 'summary']) }}">
                                <i class="fas fa-file-csv me-2"></i>Summary Report (CSV)
                            </a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.reports.export', ['type' => 'document_types']) }}">
                                <i class="fas fa-file-csv me-2"></i>Document Types Report (CSV)
                            </a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.reports.export', ['type' => 'processing_times']) }}">
                                <i class="fas fa-file-csv me-2"></i>Processing Times Report (CSV)
                            </a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.reports.export', ['type' => 'queue_performance']) }}">
                                <i class="fas fa-file-csv me-2"></i>Queue Performance Report (CSV)
                            </a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.reports.export', ['type' => 'registrar_performance']) }}">
                                <i class="fas fa-file-csv me-2"></i>Registrar Performance Report (CSV)
                            </a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.reports.export', ['type' => 'revenue']) }}">
                                <i class="fas fa-file-csv me-2"></i>Revenue Report (CSV)
                            </a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="{{ route('admin.reports.export', ['type' => 'predictive']) }}">
                                <i class="fas fa-file-csv me-2"></i>🆕 Predictive Analytics Report (CSV)
                            </a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.reports.export', ['type' => 'trends']) }}">
                                <i class="fas fa-file-csv me-2"></i>🆕 Trend Analysis Report (CSV)
                            </a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.reports.export', ['type' => 'performance']) }}">
                                <i class="fas fa-file-csv me-2"></i>🆕 Performance Metrics Report (CSV)
                            </a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.reports.export', ['type' => 'complete']) }}">
    ...
    <div class="row mb-4">
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="stats-card position-relative">
                ...
                <div class="stats-number primary-stat">{{ number_format($totalUsers) }}</div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="stats-card position-relative">
                ...
                <div class="stats-number success-stat">{{ number_format($totalStudents) }}</div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="stats-card position-relative">
                ...
                <div class="stats-number info-stat">{{ number_format($totalRegistrars) }}</div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="stats-card position-relative">
                ...
                <div class="stats-number warning-stat">{{ number_format($totalDocuments) }}</div>
                ...
                <div class="row mt-3">
                    <div class="col-6 text-center">
                        <div class="metric-card">
                            <div class="metric-value text-info">{{ $totalOnlineRequests ?? 0 }}</div>
                            <div class="metric-label">Total Student Requests</div>
                        </div>
                    </div>
                    <div class="col-6 text-center">
                        <div class="metric-card">
                            <div class="metric-value text-success">{{ $completedRequests ?? 0 }}</div>
        ...
        <div class="col-lg-6">
            <div class="report-section">
                ...
                <div class="row mt-3">
                    <div class="col-6 text-center">
                        <div class="metric-card">
                            <div class="metric-value text-info">{{ $totalOnsiteRequests ?? 0 }}</div>
                            <div class="metric-label">Total Onsite Requests</div>
                        </div>
                    </div>
                    <div class="col-6 text-center">
                        <div class="metric-card">
                            <div class="metric-value text-success">{{ \App\Models\OnsiteRequest::where('status', 'completed')->count() }}</div>
                            <div class="metric-label">Completed</div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-8">
            <div class="report-section">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="metric-card">
                            <div class="metric-value text-warning">{{ number_format($pendingRequests) }}</div>
                            <div class="metric-label">Pending</div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="metric-card">
                            <div class="metric-value text-info">{{ number_format($processingRequests) }}</div>
                            <div class="metric-label">Processing</div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="metric-card">
                            <div class="metric-value text-success">{{ number_format($readyRequests) }}</div>
                            <div class="metric-label">Ready</div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="metric-card">
                            <div class="metric-value text-primary">{{ number_format($completedRequests) }}</div>
                            <div class="metric-label">Completed</div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-12">
            <div class="report-section">
                ...
                <div class="row mb-4">
                    <div class="col-md-3">
                        <div class="metric-card">
                            <div class="metric-value text-warning">{{ $predictiveAnalytics['summary']['total_pending'] }}</div>
                            <div class="metric-label">Requests in Queue</div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="metric-card">
                            <div class="metric-value text-info">{{ $predictiveAnalytics['summary']['avg_processing_hours'] }}h</div>
                            <div class="metric-label">Avg Processing Time</div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="metric-card">
                            <div class="metric-value text-primary" style="font-size: 1.4rem;">{{ $predictiveAnalytics['summary']['estimated_queue_clear_time'] }}</div>
                ...
                <!-- Predictions Table -->
                @if($predictiveAnalytics['predictions']->count() > 0)
                ...
                <div class="table-responsive">
                    <table class="table table-stats">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><strong>{{ $prediction['reference_no'] }}</strong></td>
                                <td>
                                    <span class="badge bg-secondary">{{ $prediction['queue_position'] }}</span>
                                </td>
                                <td>{{ $prediction['estimated_release'] }}</td>
                                <td>{{ $prediction['estimated_hours'] }} hours</td>
                                <td>
                                    @php
                                        $badgeClass = $prediction['confidence'] === 'high' ? 'success' : 
                                                     ($prediction['confidence'] === 'medium' ? 'warning' : 'danger');
                                    @endphp
                                    <span class="badge bg-{{ $badgeClass }}">{{ ucfirst($prediction['confidence']) }}</span>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
        ...
        <div class="col-12">
            <div class="report-section">
                ...
                <div class="row mb-4">
                    <div class="col-md-3">
                        <div class="metric-card">
                            <div class="metric-value">{{ $documentStatistics['total_document_types'] }}</div>
                            <div class="metric-label">Document Types Available</div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="metric-card">
                            <div class="metric-value">₱{{ number_format($documentStatistics['avg_document_price'], 2) }}</div>
                            <div class="metric-label">Average Document Price</div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="metric-card">
                            <div class="metric-value">₱{{ number_format($documentStatistics['most_expensive']->price ?? 0, 2) }}</div>
                            <div class="metric-label">Most Expensive</div>
                            <small class="text-muted">{{ $documentStatistics['most_expensive']->type_document ?? 'N/A' }}</small>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="metric-card">
                            <div class="metric-value">₱{{ number_format($documentStatistics['least_expensive']->price ?? 0, 2) }}</div>
                            <div class="metric-label">Least Expensive</div>
                            <small class="text-muted">{{ $documentStatistics['least_expensive']->type_document ?? 'N/A' }}</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-stats">
                        ...
                        <tbody>
                            @foreach($documentStatistics['top_documents'] as $doc)
                            <tr>
                                <td><strong>{{ $doc['type_document'] }}</strong></td>
                                <td>{{ number_format($doc['total_requests']) }}</td>
                                <td>₱{{ number_format($doc['total_revenue'], 2) }}</td>
                                <td>{{ number_format($doc['avg_quantity_per_request'], 1) }}</td>
                                <td>
                                    @if($doc['trend'] === 'increasing')
                                        <span class="text-success">
                                            <i class="fas fa-arrow-up"></i> +{{ $doc['trend_percentage'] }}%
                                        </span>
                                    @elseif($doc['trend'] === 'decreasing')
                                        <span class="text-danger">
                                            <i class="fas fa-arrow-down"></i> {{ $doc['trend_percentage'] }}%
                                        </span>
                                    @elseif($doc['trend'] === 'new')
    ...
    <div class="row mb-4">
        <div class="col-lg-4">
            <div class="report-section">
                ...
                <div class="metric-card">
                    <div class="metric-value">{{ $avgProcessingTime['formatted'] ?? '0 minutes' }}</div>
                    <div class="metric-label">Average Processing Time</div>
                </div>
                @if(isset($processingTimeStats))
                <div class="row">
                    <div class="col-6">
                        <div class="text-center mb-3">
                            <div class="metric-value text-success">{{ number_format($processingTimeStats['under_1_hour']) }}</div>
                            <div class="metric-label">Under 1 Hour</div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="text-center mb-3">
                            <div class="metric-value text-warning">{{ number_format($processingTimeStats['under_4_hours']) }}</div>
                            <div class="metric-label">1-4 Hours</div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="text-center mb-3">
                            <div class="metric-value text-info">{{ number_format($processingTimeStats['under_24_hours']) }}</div>
                            <div class="metric-label">4-24 Hours</div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="text-center mb-3">
                            <div class="metric-value text-danger">{{ number_format($processingTimeStats['over_24_hours']) }}</div>
    ...
    <div class="row mb-4">
        <div class="col-lg-8">
            <div class="report-section">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <div class="metric-card">
                            <div class="metric-value">{{ $trendAnalytics['weekly_trend']['this_week'] }}</div>
                    ...
                    <div class="col-md-6">
                        <div class="metric-card">
                            <div class="metric-value">
                                @if($trendAnalytics['weekly_trend']['trend_direction'] === 'up')
                                    <span class="text-success">
                                        <i class="fas fa-arrow-up"></i> +{{ $trendAnalytics['weekly_trend']['percentage_change'] }}%
                                    </span>
                                @elseif($trendAnalytics['weekly_trend']['trend_direction'] === 'down')
                                    <span class="text-danger">
                                        <i class="fas fa-arrow-down"></i> {{ $trendAnalytics['weekly_trend']['percentage_change'] }}%
                                    </span>
                                @else
                                    <span class="text-muted">
                                        <i class="fas fa-minus"></i> Stable
                ...
                <div class="table-responsive">
                    <table class="table table-stats">
                        ...
                        <tbody>
                            @php $maxDayRequests = $trendAnalytics['day_patterns']->max('requests'); @endphp
                            @foreach($trendAnalytics['day_patterns'] as $dayPattern)
                            <tr>
                                <td><strong>{{ $dayPattern['day'] }}</strong></td>
                                <td>{{ number_format($dayPattern['requests']) }}</td>
                                <td>
                                    @php
                                    ...
                                    <small class="text-muted">{{ number_format($percentage, 1) }}% of peak</small>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
        ...
        <div class="col-lg-4">
            <div class="report-section">
                ...
                <div class="metric-card">
                    <div class="metric-value">{{ number_format($quarter['requests']) }}</div>
                    <div class="metric-label">{{ $quarter['quarter'] }}</div>
                </div>
                @endforeach
                
                <div class="alert alert-info mt-3">
                    <h6><i class="fas fa-lightbulb me-2"></i>Insights</h6>
                    <p class="mb-1"><strong>Peak Day:</strong> {{ $trendAnalytics['peak_day']['day'] ?? 'N/A' }} ({{ number_format($trendAnalytics['peak_day']['requests'] ?? 0) }} requests)</p>
                    <p class="mb-0"><strong>Slowest Day:</strong> {{ $trendAnalytics['slowest_day']['day'] ?? 'N/A' }} ({{ number_format($trendAnalytics['slowest_day']['requests'] ?? 0) }} requests)</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="report-section">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="metric-card">
                            <div class="metric-value text-success">{{ $performanceMetrics['completion_rate'] }}%</div>
                            <div class="metric-label">Completion Rate</div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="metric-card">
                            <div class="metric-value text-primary">{{ $performanceMetrics['sla_compliance_rate'] }}%</div>
                            <div class="metric-label">SLA Compliance</div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="metric-card">
                            <div class="metric-value text-info">{{ $performanceMetrics['resource_utilization'] }}%</div>
                            <div class="metric-label">Resource Utilization</div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="metric-card">
                            <div class="metric-value text-warning">{{ $performanceMetrics['error_rate'] }}%</div>
                            <div class="metric-label">Error Rate</div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="metric-card">
                            <div class="metric-value text-success">{{ $performanceMetrics['customer_satisfaction'] }}%</div>
                            <div class="metric-label">Satisfaction</div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="metric-card">
                            <div class="metric-value">{{ $performanceMetrics['avg_daily_requests'] }}</div>
                ...
                <div class="alert alert-warning mt-3">
                    ...
                    <p class="mb-0"><strong>Highest Load Day:</strong> {{ $performanceMetrics['peak_load']['date'] }} with {{ number_format($performanceMetrics['peak_load']['requests']) }} requests</p>
                </div>
                @endif
            </div>
        </div>
    ...
    <div class="row mb-4">
        <div class="col-lg-6">
            <div class="report-section">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="metric-card">
                            <div class="metric-value">{{ number_format($queueStats['daily_processed']) }}</div>
                            <div class="metric-label">Processed Today</div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="metric-card">
                            <div class="metric-value">{{ number_format($queueStats['weekly_processed']) }}</div>
                            <div class="metric-label">Processed This Week</div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="metric-card">
                            <div class="metric-value">{{ number_format($queueStats['monthly_processed']) }}</div>
                            <div class="metric-label">Processed This Month</div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="metric-card">
                            <div class="metric-value text-warning">{{ number_format($queueStats['current_queue_size']) }}</div>
        ...
        <div class="col-lg-6">
            <div class="report-section">
                ...
                <div class="metric-card">
                    <div class="metric-value text-success">₱{{ number_format($revenueStats['total'], 2) }}</div>
                    <div class="metric-label">Total Revenue</div>
                </div>
                <div class="metric-card">
                    <div class="metric-value text-info">₱{{ number_format($revenueStats['monthly'], 2) }}</div>
                ...
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <span>{{ $revenue->type_document }}</span>
                    <strong>₱{{ number_format($revenue->revenue, 2) }}</strong>
                </div>
                @endforeach
                @endif
            </div>
    ...
    @if(isset($registrarPerformance) && $registrarPerformance->count() > 0)
    <div class="row mb-4">
        <div class="col-12">
            <div class="report-section">
                <h4 class="chart-title">
                ...
                <div class="table-responsive">
                    <table class="table table-stats">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><strong>{{ $performance->first_name }} {{ $performance->last_name }}</strong></td>
                                <td>{{ number_format($performance->total_processed) }}</td>
                                <td>{{ number_format($performance->avg_processing_minutes, 1) }} minutes</td>
                                <td>
                                    @php
                                    ...
                                    @endphp
                                    <span class="badge bg-{{ $badgeClass }}">{{ ucfirst(str_replace('-', ' ', $rating)) }}</span>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                    ...
                    <table class="table table-stats">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ number_format($trend['requests']) }}</td>
                                <td>
                                    @if($index > 0)
                                        @php
                                        ...
                                        @endphp
                                        @if($change > 0)
                                            <span class="text-success"><i class="fas fa-arrow-up"></i> +{{ number_format($change, 1) }}%</span>
                                        @elseif($change < 0)
                                            <span class="text-danger"><i class="fas fa-arrow-down"></i> {{ number_format($change, 1) }}%</span>
                                        @else
    ...
    <!-- Peak Hours Analysis -->
    @if(isset($peakHoursData) && $peakHoursData->count() > 0)
    <div class="row mb-4">
        <div class="col-12">
            <div class="report-section">
                <h4 class="chart-title">
                ...
                <div class="table-responsive">
                    <table class="table table-stats">
                        ...
                        <tbody>
                            @php $maxRequests = $peakHoursData->max('requests'); @endphp
                            @foreach($peakHoursData as $hourData)
                            <tr>
                                <td><strong>{{ $hourData['hour'] }}</strong></td>
                                <td>{{ number_format($hourData['requests']) }}</td>
                                <td>
                                    @php
