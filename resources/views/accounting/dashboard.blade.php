                            ...
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    @foreach($pendingRequests as $request)
                                        <tr class="table-row">
                                            <td>
                                                <strong>{{ $request->ref_code ?? $request->reference_no }}</strong>
                                                <br><small class="text-muted">{{ $request->queue_number ?? '' }}</small>
                                                @if($request instanceof \App\Models\StudentRequest)
                                            ...
                                            <td>
                                                ₱{{ number_format($request->requestItems->sum(function($item) {
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <img src="{{ route('accounting.receipt.onsite', $request) }}"
                                                         ...
                                                         class="img-thumbnail"
                                                         style="max-width: 80px; max-height: 80px; cursor: pointer;"
                                                         onclick="openReceiptModal('{{ route('accounting.receipt.onsite', $request) }}', '{{ $request->reference_no ?? $request->id }}')">
                                                @endif
                                            </td>
