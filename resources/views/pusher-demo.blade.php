                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="alert alert-info">
                                    ...
                                    <div><strong>Key:</strong> <code>{{ config('broadcasting.connections.pusher.key') }}</code></div>
                                    <div><strong>Cluster:</strong> <code>{{ config('broadcasting.connections.pusher.options.cluster') }}</code></div>
                                </div>
                            </div>
                        </div>
