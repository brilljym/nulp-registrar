        ...
        @auth
            <div class="user-dropdown" id="userDropdown">
                ...
                <div class="user-dropdown-menu">
                    @if(Auth::user()->role && Auth::user()->role->name === 'registrar')
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-content">
            ...
            <div class="nav-section">
                ...
                <a href="{{ route('registrar.all-requests') }}" class="{{ request()->routeIs('registrar.all-requests') ? 'active' : '' }}">
                    <i class="bi bi-grid-3x3-gap"></i>
                    <span class="nav-text">ALL</span>
                </a>
                <a href="{{ route('registrar.completed') }}" class="{{ request()->routeIs('registrar.completed') ? 'active' : '' }}">
                    <i class="bi bi-check-circle"></i>
                    <span class="nav-text">COMPLETED</span>
                </a>
                <a href="{{ route('registrar.pending') }}" class="{{ request()->routeIs('registrar.pending') ? 'active' : '' }}">
            ...
            <div class="nav-section">
                ...
                <a href="{{ route('registrar.onsite.management') }}" class="{{ request()->routeIs('registrar.onsite.management') ? 'active' : '' }}">
                    <i class="bi bi-grid-3x3-gap"></i>
                    <span class="nav-text">ALL</span>
                </a>
                <a href="{{ route('registrar.onsite.completed') }}" class="{{ request()->routeIs('registrar.onsite.completed') ? 'active' : '' }}">
                    <i class="bi bi-check-circle"></i>
                    <span class="nav-text">COMPLETED</span>
                </a>
                <a href="{{ route('registrar.onsite.pending') }}" class="{{ request()->routeIs('registrar.onsite.pending') ? 'active' : '' }}">
                    <i class="bi bi-clock"></i>
                    <span class="nav-text">PENDING</span>
                </a>
            </div>
            ...
            <div class="nav-section">
                ...
                <a href="{{ route('registrar.analytics') }}" class="{{ request()->routeIs('registrar.analytics') ? 'active' : '' }}" title="View system analytics and reports">
        ...
        <main class="main-content">
            <div class="container-fluid py-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div></div>
                    @if(!request()->routeIs('registrar.analytics'))
                    <form method="GET" action="{{ route('registrar.dashboard') }}" class="content-search-form">
                        <div class="input-group">
                            <input type="text" name="search" class="form-control" placeholder="Search by name, ID, or doc" value="{{ request('search') }}" autocomplete="off">
