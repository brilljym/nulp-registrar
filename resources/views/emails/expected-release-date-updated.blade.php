    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="request-details">
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $onsiteRequest->created_at->format('Ymd') }}-i{{ $onsiteRequest->id }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Reference Code:</span>
                    <span class="detail-value">{{ $onsiteRequest->ref_code ?? 'Not available' }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Course:</span>
                    <span class="detail-value">{{ $onsiteRequest->course }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Year Level:</span>
                    <span class="detail-value">{{ $onsiteRequest->year_level }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Department:</span>
                    <span class="detail-value">{{ $onsiteRequest->department }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Status:</span>
                    <span class="detail-value">
                        <span class="status-badge status-completed">{{ ucfirst($onsiteRequest->status) }}</span>
                    </span>
                </div>
                <div class="detail-row">
        ...
        <div class="footer">
            ...
            <div class="ticket-number">
                Ticket: {{ $onsiteRequest->created_at->format('Ymd') }}-i{{ $onsiteRequest->id }}
            </div>
        </div>
    </div>
</body>
