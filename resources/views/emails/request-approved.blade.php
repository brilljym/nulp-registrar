...
<head>
    ...
    <title>NU Lipa - Request Approved</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-container">
        <div class="header">
            ...
            <p>Your {{ $requestType }} document request has been approved</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="message">
                <p>Great news! Your {{ $requestType }} document request has been approved by our registrar's office. Your request is now ready for the next steps in the processing workflow.</p>
            </div>
            ...
            <div class="request-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">
                        <span class="status-badge status-approved">{{ ucfirst(str_replace('_', ' ', $request->status)) }}</span>
                    </span>
                </div>
                <div class="detail-row">
            ...
            <div class="message">
                ...
                <p>Your approved request will now proceed to the payment and processing stages. If payment is required for your documents, you will receive a separate notification with payment instructions.</p>

                <p>You can track the progress of your request at any time through our online tracking system. We'll keep you updated on each step of the process.</p>

                <p>If you have any questions about your approved request, please don't hesitate to contact the registrar's office.</p>
            </div>
        </div>
