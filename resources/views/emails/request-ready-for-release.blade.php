...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="message">
                <p>Excellent news! Your {{ $requestType }} document request has been processed and is now Ready. Please check your email for further updates about your requested documents. </p>
            </div>
            ...
            <div class="request-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">
                        <strong style="font-size: 18px; color: #2c2f92;">{{ $request->queue_number }}</strong>
                    </span>
                </div>
                @endif
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">
                        <span class="status-badge status-released">{{ ucfirst($request->status) }}</span>
                    </span>
                </div>
                <div class="detail-row">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ \Carbon\Carbon::parse($request->expected_release_date)->format('M j, Y g:i A') }}</span>
                </div>
                @endif
            </div>
            ...
            <div class="highlight-box">
                ...
                <div class="highlight-subtext">
                    ...
                    @if($request->queue_number)
                        <br><strong>Your Queue Number: {{ $request->queue_number }}</strong>
                    @endif
                </div>
            </div>
            ...
            <div class="message">
                ...
                <ul>
                    @if($request->queue_number)
                    <li><strong>Your queue number: {{ $request->queue_number }}</strong> (use this at the kiosk)</li>
                    @endif
                    <li>Your reference code: <strong>{{ $requestType === 'onsite' ? $request->ref_code : $request->reference_no }}</strong></li>
